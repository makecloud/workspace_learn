...
public class MapActivity extends AppCompatActivity implements LocationSource, AMapLocationListener, GeocodeSearch.OnGeocodeSearchListener, PoiSearch.OnPoiSearchListener { //
        ...
        aMap.setOnCameraChangeListener(new AMap.OnCameraChangeListener() {
            ...
            public void onCameraChangeFinish(CameraPosition cameraPosition) {
                ...
                if (!isItemClickAction) {
                    //cameraPosition.target 目标位置的屏幕中心点经纬度坐标。
...
//                mListener.onLocationChanged(amapLocation);// 点击定位按钮，通过此代码移动到屏幕中央
    ...
    public void onRegeocodeSearched(RegeocodeResult result, int rCode) {
        ...
        if (rCode == 1000) {
            if (result != null && result.getRegeocodeAddress() != null && result.getRegeocodeAddress().getFormatAddress() != null) {
                String address = result.getRegeocodeAddress().getProvince() + result.getRegeocodeAddress().getCity() + result.getRegeocodeAddress().getDistrict() + result
...
//                isInputKeySearch = false;
    ...
    private void addMarkerInScreenCenter(LatLng locationLatLng) {
        ...
        locationMarker = aMap.addMarker(new MarkerOptions().anchor(0.5f, 0.5f).icon(BitmapDescriptorFactory.fromResource(R.drawable.purple_pin)));
    ...
    private void searchPoi(Tip result) {
        ...
        inputSearchKey = result.getName();//getAddress(); // + result.getRegeocodeAddress().getCity() + result.getRegeocodeAddress().getDistrict() + result.getRegeocodeAddress()
        // .getTownship();
