...
public class DesUtil {
	...
	private synchronized static SecretKey generateKey(String secretKey)
	 ...
	 */
	public synchronized static String encrypt(String resStr) throws BadPaddingException,
	 ...
	 */
	public synchronized static String decrypt(String resStr) throws NoSuchAlgorithmException,
		...
		byte[] decryptedByte = decryptCipher.doFinal(Base64.decode(resStr.getBytes("utf-8"),
				Base64.DEFAULT));
